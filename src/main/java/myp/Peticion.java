...
public class Peticion {
	...
	public Respuesta get() throws Exception {
		...
		String urlString = "https://api.openweathermap.org/data/2.5/onecall?lat=" + this.latitud + "&lon="
				+ this.longitud
				+ "&units=metric&exclude=hourly,daily,minutely&lang=sp&appid=5aac2dc7618e3fd43f31263400bc1788";
